...
``glowcord.ext.tasks`` -- asyncio.Task helpers
====================================================
...
The goal of this glowcord extension is to abstract all these worries away from you.

Recipes
---------

A simple background task in a :class:`~glowcord.ext.commands.Cog`:

.. code-block:: python3

    from glowcord.ext import tasks, commands
...
.. code-block:: python3
    ...
    from glowcord.ext import tasks
...
.. attributetable:: glowcord.ext.tasks.Loop

.. autoclass:: glowcord.ext.tasks.Loop()
    :members:
...
.. autofunction:: glowcord.ext.tasks.loop
